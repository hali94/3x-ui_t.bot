...
from sqlalchemy import BigInteger, String, Enum, DateTime, Boolean, func
...
class User(Base):
    ...
    # Relationships
    reseller_profile: Mapped["Reseller"] = relationship("Reseller", back_populates="user", uselist=False)
